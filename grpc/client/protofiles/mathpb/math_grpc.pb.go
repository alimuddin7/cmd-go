...
type MathServiceClient interface {
	// unary
	Math(ctx context.Context, in *MathRequest, opts ...grpc.CallOption) (*MathResponse, error)
}
...
func (c *mathServiceClient) Math(ctx context.Context, in *MathRequest, opts ...grpc.CallOption) (*MathResponse, error) {
	out := new(MathResponse)
	err := c.cc.Invoke(ctx, "/protofiles.MathService/Math", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MathServiceServer interface {
	// unary
	Math(context.Context, *MathRequest) (*MathResponse, error)
}
...
func (UnimplementedMathServiceServer) Math(context.Context, *MathRequest) (*MathResponse, error) {
...
func _MathService_Math_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MathRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MathServiceServer).Math(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protofiles.MathService/Math",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MathServiceServer).Math(ctx, req.(*MathRequest))
	}
...
var MathService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protofiles.MathService",
	HandlerType: (*MathServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Math",
			Handler:    _MathService_Math_Handler,
		},
	},
